...
public class Check_DeleteThisSequenceButton_Disabled_In_DetailTab_Seq_XREF_GF {
	...
	@Test(enabled = true, description = "Check 'Delete This Sequence' Button disabled in Detail Tab of Sequence section in tabbed view GF(GF has an XREF created by another user) ", groups = {
