package com.syngenta.sylk.tabbedui.detailedtab.test;
...
public class Check_CreatedBy_NameAndTimeStamp_In_DetailTab_GF {
	...
	@Test(enabled = true, description = "Check 'created by' name and time stamp in tabbed view GF", dataProvider = "TestData", groups = {
