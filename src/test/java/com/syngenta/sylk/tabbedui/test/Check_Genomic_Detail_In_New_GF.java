...
public class Check_Genomic_Detail_In_New_GF {
	...
	@Test(enabled = true, description = "Check created by name and time stamp in tabbed view GF Chromosome and Ecotype", dataProvider = "checkrnaiingf", groups = {
			"checkCreatedByAndTimeStampInTabbedGF", "GF", "regression"})
	public void checkCreatedByAndTimeStampInTabbedGF_ChromosomeAndEcotype(
