...
public class Check_That_UserCanSearchForAnExisting_GF_Synonyms {
	...
	private String existingGFName = " Q2_Existing_Synonyms ";
	private GeneticFeaturePage gfpage;

	@BeforeClass(alwaysRun = true)
	public void loadData() {
		this.testData = new CommonLibrary()
				.getTestDataAsObjectArray("Check_That_UserCanSearchForAnExisting_GF_Synonyms.xlsx");
	}
	...
	public void check_That_UserCanSearchForANewAdded_GF_Synonyms(
		...
		try {
			...
			// BasePage page =
			// blastSearchResultPage.clickAddAsNewGFAndGoToNewGFPage();
			...
			// reporter.reportPass("enter eixting GF synonyms \"" + synonymsText
			// + "\" in Synonym field");
			//
