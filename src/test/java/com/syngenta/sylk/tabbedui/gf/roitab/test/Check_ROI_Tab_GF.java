package com.syngenta.sylk.tabbedui.gf.roitab.test;
...
public class Check_ROI_Tab_GF {
	...
	public class Check_ROI_Tab_In_GF {
		...
		// private AddNewRegionOfInterestROIPage addNewROIpage;
		...
		public void addNewGeneticFeatureProtein(String testDescription,
			...
			try {
				...
				BasePage page = common.searchAndSelectThisGF(this.homepage,
						user, gfName);
				...
				addnewROIPage.selectReferenceGenome(columns
				...
				reporter.verifyEqual(roiDetailspage.getPageTitle(),
						PageTitles.roi_detail_page,
						"ROI is created successfully.");

				// step 5
				this.searchSylkpage = this.homepage
