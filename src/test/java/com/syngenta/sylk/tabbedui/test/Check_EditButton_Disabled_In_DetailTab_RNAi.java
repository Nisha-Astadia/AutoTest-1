...
public class Check_EditButton_Disabled_In_DetailTab_RNAi {
	...
	@Test(enabled = true, description = "Check Edit Button disabled in details Tab in tabbed view RNAi (User doesn't have Curator role, and RNAi was created by another user) ", dataProvider = "checkEditButtonDisabled", groups = {
