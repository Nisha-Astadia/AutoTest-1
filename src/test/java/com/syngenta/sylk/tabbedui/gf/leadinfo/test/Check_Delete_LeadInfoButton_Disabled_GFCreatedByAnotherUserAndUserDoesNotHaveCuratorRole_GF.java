 ...
 * 
 */
public class Check_Delete_LeadInfoButton_Disabled_GFCreatedByAnotherUserAndUserDoesNotHaveCuratorRole_GF {
	...
	public void check_Edit_LeadInfo_Disabled() {
		...
		try {
			...
			if (page instanceof GeneticFeaturePage) {
				...
				String step4 = "hover over the disabled button. a pop-up with \"Lead was created by another user"
