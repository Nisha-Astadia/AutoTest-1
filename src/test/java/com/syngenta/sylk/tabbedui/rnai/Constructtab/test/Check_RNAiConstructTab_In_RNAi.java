package com.syngenta.sylk.tabbedui.rnai.Constructtab.test;
...
public class Check_RNAiConstructTab_In_RNAi {
	...
	@Test(enabled = true, description = "Check RNAi Construct tab in Tabbed View RNAI", dataProvider = "checkDifferentFieldsInConstructTabSeq", groups = {
			"Check_RNAiConstructTab_In_RNAi", "RNAI", "regression"})
