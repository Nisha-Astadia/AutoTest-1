...
public class Check_ThatUserCanSearchByEdited_GF_Name {
	...
	private String proteinData = "1 mtihvidtst ifmrkayyen mvtipevvde irdensqfyf sllnlrveea snrnvekvir"
	...
	private String name = "editName_GF";
	private String editedname = "name_GF_updated";
	...
	@Test(enabled = true, description = "check that user can search by edited GF>> Name", groups = {
	...
	public void checkAlreadyExistinGF_ContainerSourceCode() {
		...
		reporter.reportPass("enter \"" + this.editedname + "\" in name field");
